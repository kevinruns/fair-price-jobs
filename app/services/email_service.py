#!/usr/bin/env python3
"""
OAuth-based Email Service for Fair Price Application
...
class EmailService:
    ...
    def send_group_invitation(self, to_email: str, group_name: str, inviter_name: str, 
        ...
        <body>
            ...
            <p>Hello,</p>
            <p>{inviter_name} has invited you to join the group <strong>{group_name}</strong> on Fair Price.</p>
            <p>Fair Price is a platform where you can share and discover trusted tradesmen with your community.</p>
            ...
            <p>Best regards,<br>The Fair Price Team</p>
        </body>
        </html>
        """
